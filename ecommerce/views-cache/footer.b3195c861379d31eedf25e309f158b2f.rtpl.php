<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="footer-top-area">
    ...
    <!-- jQuery sticky menu -->
    <script src="/resour/site/js/owl.carousel.min.js"></script>
    <script src="/resour/site/js/jquery.sticky.js"></script>
    
    <!-- jQuery easing -->
    <script src="/resour/site/js/jquery.easing.1.3.min.js"></script>
    
    <!-- Main Script -->
    <script src="/resour/site/js/main.js"></script>
    
    <!-- Slider -->
    <script type="text/javascript" src="/resour/site/js/bxslider.min.js"></script>
	<script type="text/javascript" src="/resour/site/js/script.slider.js"></script>
  </body>
</html>