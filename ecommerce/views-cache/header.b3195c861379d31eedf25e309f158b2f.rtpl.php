...
<html lang="pt-br">
  <head>
    ...
    <!-- Bootstrap -->
    <link rel="stylesheet" href="/resour/site/css/bootstrap.min.css">
    
    <!-- Font Awesome -->
    <link rel="stylesheet" href="/resour/site/css/font-awesome.min.css">
    
    <!-- Custom CSS -->
    <link rel="stylesheet" href="/resour/site/css/owl.carousel.css">
    <link rel="stylesheet" href="/resour/site/css/style.css">
    <link rel="stylesheet" href="/resour/site/css/responsive.css">
    ...
    <div class="site-branding-area">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <div class="logo">
                        <h1><a href="#"><img src="/resour/site/img/logo.png"></a></h1>
                    </div>
                </div>
